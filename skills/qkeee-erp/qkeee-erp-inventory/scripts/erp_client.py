...
def _cli():
    ...
    rp.add_argument("--persona-code", required=True, help="e.g. qkeee-erp-inventory")
    rp.add_argument("--persona-label", required=True, help="display name, e.g. 'Inventory'")
    ...
    if args.command in ("health", "query", "get", "bin-qty", "recon-items", "mutate",
