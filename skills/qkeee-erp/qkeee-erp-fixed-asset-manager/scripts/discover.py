#!/usr/bin/env python3
"""
qkeee-erp-fixed-asset-manager discovery helper — resolves what's actually installed on a
...
def _cli():
    ...
    p.add_argument("--persona-code", default="qkeee-erp-fixed-asset-manager",
